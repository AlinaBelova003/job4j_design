...
public class PrintWrite {
    /**
     * PrintWriter - это символьный аналог класса PrintStream.
     * Для вывода текста в консоль лучше подходит PrintWriter, а если с байтовыми или смешанными данными, то PrintStream
     *
     */
